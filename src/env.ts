...
export const env = createEnv({
  ...
  server: {
    ...
    // transactions on the transactional Prisma client.
    ...
    // Cron bearer secret: cron routes read env.CRON_SECRET with a
    // raw-process fallback + loud 500 when unset. Optional here so
    // secret-less dev boots; prod must set it on Vercel.

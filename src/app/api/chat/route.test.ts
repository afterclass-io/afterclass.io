...
// route.ts reads the canonical chat-config directly.
...
describe("POST /api/chat", () => {
  ...
  // -- 503 chat kill-switch (after consent 403, before body parse) --
  ...
  // Gate precedence: consent-null + chatEnabled=false →

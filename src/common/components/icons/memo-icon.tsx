...
export const MemoIcon = (props: CustomIconProps) => {
  return (
    ...
    >
      ...
      <path
        fill="#99aab5"
        d="M27 24a1 1 0 0 1-1 1H6a1 1 0 1 1 0-2h20a1 1 0 0 1 1 1m-16 4a1 1 0 0 1-1 1H6a1 1 0 1 1 0-2h4a1 1 0 0 1 1 1M27 8a1 1 0 0 1-1 1H6a1 1 0 0 1 0-2h20a1 1 0 0 1 1 1m0 4a1 1 0 0 1-1 1H6a1 1 0 1 1 0-2h20a1 1 0 0 1 1 1m0 4a1 1 0 0 1-1 1H6a1 1 0 1 1 0-2h20a1 1 0 0 1 1 1m0 4a1 1 0 0 1-1 1H6a1 1 0 1 1 0-2h20a1 1 0 0 1 1 1"
      ></path>
      <path
        fill="#66757f"
        d="M31 6.272c-.827-.535-1.837-.579-2.521-.023l-.792.646l-1.484 1.211l-.1.08l-2.376 1.938l-11.878 9.686c-.437.357-.793 1.219-1.173 2.074c-.378.85-.969 2.852-1.443 4.391c-.148.25-1.065 1.846-.551 2.453c.52.615 2.326.01 2.568-.076c1.626-.174 3.731-.373 4.648-.58c.924-.211 1.854-.395 2.291-.752c.008-.006.01-.018.017-.023l11.858-9.666l.792-.646l.144-.118z"
      ></path>
      <path
        fill="#d99e82"
        d="M18.145 22.526s-1.274-1.881-2.117-2.553c-.672-.843-2.549-2.116-2.549-2.116c-.448-.446-1.191-.48-1.629-.043c-.437.438-.793 1.366-1.173 2.291c-.472 1.146-1.276 4.154-1.768 5.752c-.083.272.517-.45.503-.21c-.01.187.027.394.074.581l-.146.159l.208.067l.068.21l.159-.146c.187.047.394.084.58.074c.24-.014-.483.587-.21.503c1.598-.493 4.607-1.296 5.752-1.768c.924-.381 1.854-.736 2.291-1.174c.439-.435.406-1.178-.043-1.627"
      ></path>
      <path
        fill="#ea596e"
        d="M25.312 4.351a2.24 2.24 0 0 0 0 3.168l3.167 3.168a2.24 2.24 0 0 0 3.168 0l3.169-3.168a2.24 2.24 0 0 0 0-3.168l-3.169-3.168a2.24 2.24 0 0 0-3.168 0z"
      ></path>
      <path
        fill="#ffcc4d"
        d="m11.849 17.815l3.17 3.17l3.165 3.166l11.881-11.879l-6.337-6.336z"
      ></path>
      <path
        fill="#292f33"

...
describe("supabase-consent", () => {
  ...
  it("round-trips a JWT-shaped bearer without exposing it", () => {
    const bearer = "eyJoZWFkZXI.cGF5bG9hZA.c2ln";
    const t = issueConsentCsrf(bearer, "secret");
    expect(verifyConsentCsrf(t, bearer, "secret")).toBe(true);

...
describe("tool schema & types smoke", () => {
  ...
  it("catalog keeps the documented 45 tools (personal account/shared-token tools removed): 25 readOnly + 20 write", () => {
    ...
    expect(writeTools.some((t) => t.name === "explore-bid-options")).toBe(
      false,
    );
    expect(

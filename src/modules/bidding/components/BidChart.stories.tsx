...
export const SinglePointPerTerm: Story = {
  args: {
    chartData: [
      { bidWindow: "AY202223T1/1A/2", price: [18, 24] as [number, number], size: 40 },
      { bidWindow: "AY202324T1/1A/2", price: [20, 26] as [number, number], size: 38 },
      { bidWindow: "AY202425T1/1A/2", price: [22, 27] as [number, number], size: 35 },
      { bidWindow: "AY202526T1/1A/2", price: [24, 30] as [number, number], size: 42 },
    ],
  },
};
...
export const MultipleRoundsPerTerm: Story = {
  args: {
    chartData: [
      { bidWindow: "AY202425T1/1/1", price: [16, 20] as [number, number], size: 30 },
      { bidWindow: "AY202425T1/1/2", price: [18, 22] as [number, number], size: 34 },
      { bidWindow: "AY202425T1/1A/2", price: [21, 26] as [number, number], size: 36 },
      { bidWindow: "AY202425T1/2/1", price: [24, 29] as [number, number], size: 33 },
    ],
  },
};
...
export const LargeAmounts: Story = {
  args: {
    chartData: [
      { bidWindow: "AY202425T1/1/1", price: [480, 650] as [number, number], size: 40 },
      { bidWindow: "AY202425T1/1A/2", price: [520, 720] as [number, number], size: 44 },
      { bidWindow: "AY202425T1/2/1", price: [610, 810] as [number, number], size: 38 },
      { bidWindow: "AY202526T1/1/1", price: [700, 899] as [number, number], size: 50 },
      { bidWindow: "AY202526T1/1A/2", price: [760, 960] as [number, number], size: 42 },
      { bidWindow: "AY202526T1/2/1", price: [830, 999] as [number, number], size: 36 },
    ],
  },
};
